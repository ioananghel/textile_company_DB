...
(
    ...
    constraint FK_Departament_Locatie foreign key (id_locatie) references Locatie (id_locatie)
);
...
(
    ...
    constraint FK_Angajat_Manager foreign key(id_manager) references Angajat(id_angajat),
    constraint FK_Angajat_Departament foreign key(id_departament) references Departament(id_departament)
)
...
(
    ...
    constraint FK_Utilaj_Departament foreign key(id_departament) references Departament(id_departament)
)
...
(
    ...
    constraint FK_Obiect_Departament foreign key(id_departament) references Departament(id_departament)
)
...
(
    ...
    constraint FK_Client_Obiect foreign key(id_obiect) references Obiect(id_obiect)
)
...
(
    ...
    constraint FK_Comanda_Obiect foreign key(id_obiect) references Obiect(id_obiect)
)
...
(
    ...
    constraint FK_Material_Necesar foreign key(id_material) references Furnizor(id_furnizor)
)
